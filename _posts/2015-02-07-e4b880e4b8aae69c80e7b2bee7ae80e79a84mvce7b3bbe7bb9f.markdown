...
layout: post
slug: '%e4%b8%80%e4%b8%aa%e6%9c%80%e7%b2%be%e7%ae%80%e7%9a%84mvc%e7%b3%bb%e7%bb%9f'
title: 一个最精简的MVC系统
wordpress_id: 744
categories:
- ActionScript
...
[![MVC2](http://blog.domlib.com/wp-content/uploads/2015/02/MVC2.png)](http://blog.domlib.com/wp-content/uploads/2015/02/MVC2.png)
<!-- more -->
...
最后，附上完整例子：[MVC参考实现](http://blog.domlib.com/wp-content/uploads/2015/02/MVC参考实现.zip) 使用说明：这并不是一个库，因为每个类你都可能直接修改它，直接把模板拷贝到项目里用即可。正式使用时可以删掉module下的sample目录，并对应删除app包下ControllerList里的sampleController定义。
